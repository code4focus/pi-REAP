...
const regression = [task("regression-implementation", "regression", "implementation", ["high", "xhigh"]), task("regression-debugging", "regression", "debugging", ["high", "xhigh"]), task("regression-architecture", "regression", "architecture", ["xhigh"]), task("regression-high-risk", "regression", "high_risk", ["xhigh"]), task("regression-continuation", "regression", "continuation", ["high", "xhigh"])];

...
export class ExtensionHarness {
  ...
  message(stopReason: "error" | "length" | "aborted" | "stop" | "toolUse", usage?: unknown): void { this.emit("message_end", { type: "message_end", message: { role: "assistant", stopReason, usage } } as MessageEndEvent); }

...
const extension = createExtension({ load: async () => ({ enabled: true, mode: "enforce", ambiguousEffort: "high", failureEffort: "xhigh", telemetry: { enabled: true, includePromptText: false, directory: "synthetic" }, ui: { showStatus: true, notifyOnEscalation: false } }) });
